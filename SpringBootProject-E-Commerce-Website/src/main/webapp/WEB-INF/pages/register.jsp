						...
						<form action="register" method="POST">
							...
							<div class="mt-2">
								<label class="form-label">Address</label> <input type="text"
									...
									class="form-control" required="required" name="address" />
							</div>
							<div class="row">
								<div class="col-md-6 mt-2">
									<label class="form-label">City</label> <input
										class="form-control" type="text"
										placeholder="City/District/Town" required="required"
										name="city" />
								</div>
								<div class="col-md-6 mt-2">
									<label class="form-label">Pincode</label> <input
										class="form-control" type="number" placeholder="Pincode"
										maxlength="6" required="required" name="pincode" />
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 mt-2">
